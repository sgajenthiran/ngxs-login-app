...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SetSelectedList", function() { return SetSelectedList; });
...
/* harmony import */ var _product_form_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./product/form.component */ "./src/app/product/form.component.ts");
/* harmony import */ var _sale_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sale/list.component */ "./src/app/sale/list.component.ts");
...
const routes = [
    ...
    { path: 'product', component: _product_form_component__WEBPACK_IMPORTED_MODULE_5__["FormComponent"] },
    { path: 'sales', component: _sale_list_component__WEBPACK_IMPORTED_MODULE_6__["ListComponent"] },
...
/* harmony import */ var _product_form_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./product/form.component */ "./src/app/product/form.component.ts");
/* harmony import */ var _sale_list_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./sale/list.component */ "./src/app/sale/list.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _states_product_state__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./states/product.state */ "./src/app/states/product.state.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _product_form_component__WEBPACK_IMPORTED_MODULE_10__["FormComponent"],
            _sale_list_component__WEBPACK_IMPORTED_MODULE_11__["ListComponent"]
        ],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
            _ngxs_store__WEBPACK_IMPORTED_MODULE_5__["NgxsModule"].forRoot([
                _states_product_state__WEBPACK_IMPORTED_MODULE_14__["ProductState"]
            ]),
...
/* harmony import */ var _states_product_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../states/product.state */ "./src/app/states/product.state.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_3__["Select"])(_states_product_state__WEBPACK_IMPORTED_MODULE_5__["ProductState"].getList),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"])
], LoginComponent.prototype, "todos", void 0);
...
PojoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _states_product_state__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../states/product.state */ "./src/app/states/product.state.ts");
/* harmony import */ var _actions_product_action__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../actions/product.action */ "./src/app/actions/product.action.ts");
/* harmony import */ var _pojo_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../pojo.service */ "./src/app/pojo.service.ts");
...
let FormComponent = class FormComponent {
    constructor(pojoService, fb, store, route, router) {
    ...
    submitForm() {
        ...
        if (this.editFlag && this.pojoFlag) {
            this.formSubscription.add(this.store.dispatch(new _actions_product_action__WEBPACK_IMPORTED_MODULE_7__["UpdateList"](this.productForm.value, this.productForm.value.productid)).subscribe(() => {
                this.clearForm();
                this.router.navigate(['/sales']);
            }));
        }
        else {
            this.formSubscription.add(this.formSubscription = this.store.dispatch(new _actions_product_action__WEBPACK_IMPORTED_MODULE_7__["AddList"](this.productForm.value)).subscribe(() => {
                this.clearForm();
            }));
        }
    }
    ngOnInit() {
        this.pojoFlag = this.pojoService.getFlag();
        this.formSubscription.add(this.selectedList.subscribe(list => {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_3__["Select"])(_states_product_state__WEBPACK_IMPORTED_MODULE_6__["ProductState"].getSelected),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"])
], FormComponent.prototype, "selectedList", void 0);
FormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-form',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/product/form.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./form.component.scss */ "./src/app/product/form.component.scss")).default]
    }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _states_product_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../states/product.state */ "./src/app/states/product.state.ts");
/* harmony import */ var _actions_product_action__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../actions/product.action */ "./src/app/actions/product.action.ts");
/* harmony import */ var _pojo_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../pojo.service */ "./src/app/pojo.service.ts");
...
let ListComponent = class ListComponent {
    ...
    constructor(pojoService, store, router) {
        this.pojoService = pojoService;
        this.store = store;
        this.router = router;
    }
    ngOnInit() {
        this.store.dispatch(new _actions_product_action__WEBPACK_IMPORTED_MODULE_6__["GetList"]());
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Select"])(_states_product_state__WEBPACK_IMPORTED_MODULE_5__["ProductState"].getList),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"])
], ListComponent.prototype, "salelist", void 0);
ListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sale/list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./list.component.scss */ "./src/app/sale/list.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_pojo_service__WEBPACK_IMPORTED_MODULE_7__["PojoService"], _ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
], ListComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ListStateModel", function() { return ListStateModel; });
...
/* harmony import */ var _actions_product_action__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../actions/product.action */ "./src/app/actions/product.action.ts");
...
let ProductState = class ProductState {
    ...
    AddList({ getState, patchState }, { payload }) {
    ...
    UpdateList({ getState, setState }, { payload, productid }) {
        const state = getState();
        const updatedList = [...state.list];
        const updatedIndex = updatedList.findIndex(item => item.productid === productid);
        updatedList[updatedIndex] = payload;
        setState(Object.assign({}, state, { list: updatedList }));
        //  }));
    }
    RemoveList({ getState, setState }, { productid }) {
        const state = getState();
        const filteredArray = state.list.filter(item => item.productid !== productid);
        setState(Object.assign({}, state, { list: filteredArray }));
    }
    SetSelectedListId({ getState, setState }, { payload }) {
        const state = getState();
        setState(Object.assign({}, state, { selectedList: payload }));
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["Action"])(_actions_product_action__WEBPACK_IMPORTED_MODULE_2__["AddList"]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, _actions_product_action__WEBPACK_IMPORTED_MODULE_2__["AddList"]]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)
], ProductState.prototype, "AddList", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["Action"])(_actions_product_action__WEBPACK_IMPORTED_MODULE_2__["UpdateList"]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, _actions_product_action__WEBPACK_IMPORTED_MODULE_2__["UpdateList"]]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)
], ProductState.prototype, "UpdateList", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["Action"])(_actions_product_action__WEBPACK_IMPORTED_MODULE_2__["RemoveList"]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, _actions_product_action__WEBPACK_IMPORTED_MODULE_2__["RemoveList"]]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)
], ProductState.prototype, "RemoveList", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["Action"])(_actions_product_action__WEBPACK_IMPORTED_MODULE_2__["SetSelectedList"]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, _actions_product_action__WEBPACK_IMPORTED_MODULE_2__["SetSelectedList"]]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)
], ProductState.prototype, "SetSelectedListId", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["Selector"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ListStateModel]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)
], ProductState, "getList", null);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_1__["Selector"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ListStateModel]),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)
], ProductState, "getSelected", null);
ProductState = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! /Users/revad/Documents/Project/GIT/ngx/ngxstest/ngxs-login-app/src/main.ts */"./src/main.ts");
